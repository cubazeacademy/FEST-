...
CREATE TABLE IF NOT EXISTS public.category_configs (
  ...
  max_individual_programs_per_student INT DEFAULT 5,
  min_individual_programs_per_student INT DEFAULT 0,
  min_stage_programs INT DEFAULT 0,
  max_stage_programs INT DEFAULT 2,
  min_non_stage_programs INT DEFAULT 0,
  max_non_stage_programs INT DEFAULT 3,
  min_sports_programs INT DEFAULT 0,
  max_sports_programs INT DEFAULT 2,
