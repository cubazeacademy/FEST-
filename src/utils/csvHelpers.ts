...
export function generateSampleIndividualRegCSV(
  ...
  const fallback = [
    'BYNS1,PENCIL DRAWING,BIDAYA,2,101,104',
    'BYNS2,TYPING MASTER ENG,BIDAYA,2,101,104',
    'BYNS3,MS WORD,BIDAYA,2,101,104',
    'BYNS4,GK QUIZ,BIDAYA,2,101,104',
    'BYNS5,ESSAY WRITING MLM,BIDAYA,2,101,104',
    'BYNS6,HANDWRITING MLM,BIDAYA,2,101,104',
    'BYNS7,HANDWRITING ENG,BIDAYA,2,101,104',
    'BYNS8,HANDWRITING URD,BIDAYA,2,101,104',
    'BYNS9,HANDWRITINGARB,BIDAYA,2,101,104',
    'BYNS10,HANDWRITING HND,BIDAYA,2,101,104',
    'BYNS11,POEM WRITING MLM,BIDAYA,2,101,104',
    'BYNS12,CAPTION MAKING,BIDAYA,2,101,104',
    'BYNS13,DIARY WRITING MLM,BIDAYA,2,101,104',
    'BYNS14,PICTURE STORY MLM,BIDAYA,2,101,104',
    'BYNS15,DICTIONARY MAKING ARB,BIDAYA,2,101,104',
    'BYNS16,SUDOKU,BIDAYA,2,101,104',
    'BYNS17,MEMORY TEST,BIDAYA,2,101,104',
    'BYNS18,ORIGAMI,BIDAYA,2,101,104',
    'BYNS19,JIGSAW PUZZLE,BIDAYA,2,101,104',
    'BYNS20,COLORING,BIDAYA,2,101,104',
    'BYNS21,VOCABULARY,BIDAYA,2,101,104'
  ];
  return `${headers}\n${fallback.join('\n')}\n`;
}
...
export function generateSampleGroupRegCSV(
  ...
  const fallback = [
    'BAGSP16,GROUP SONG,BIDAYA,2,4,GROUP SONG Contingent 1,101;104',
    'BAGSP17,SPEECH SONG MLM,BIDAYA,2,4,SPEECH SONG MLM Contingent 2,101;104',
    'UAGSP1,GROUP SONG,ULA,2,4,GROUP SONG Contingent 4,105;108',
    'ART-STG-02,FOLK CHORUS,SENIOR,4,10,Ruby Folk Chorus,ADM-101;ADM-102;ADM-103;ADM-104',
    'SPT-TRK-02,SPRINT RELAY,SUPER_SENIOR,4,4,Ruby Sprint Relay Team,ADM-105;ADM-106;ADM-107;ADM-108'
  ];
  return `${headers}\n${fallback.join('\n')}\n`;
}
