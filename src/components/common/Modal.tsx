...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      {/* Modal Dialog */}
      <div
        className={`relative w-full ${maxWidthClass} bg-white border border-slate-200/80 rounded-3xl shadow-2xl overflow-hidden z-10 my-8 transition-all transform animate-in fade-in zoom-in-95 duration-150`}
      >
        {/* Header */}
